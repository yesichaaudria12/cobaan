 ...
 <div class="col-sm-9 col-xs-12 content pt-3 pl-0">
         ...
         <div class="alert alert-primary" role="alert">
             <div class="row align-items-center">
                 ...
                 <div class="col-lg-1" style="left: 80px;">
                     <button class="btn" style="background: #B0C4DE   ;" data-toggle="modal"
                         data-target=".myModalpassword"> Ubah Password</button>
                 </div>
             </div>
         </div>
         <div class="mt-1 mb-3 button-container">
             <div class="row pl-0">
                 ...
                 <div class="col-lg-3 col-md-3 col-sm-6 col-12 mb-3">
                     <div class="border shadow p-3 bg-danger">
                         ...
                         <p class="mt-2 text-white text-center">Konfirmasi Absen<br> <small
                                 class="bc-description text-white"></small></p>
                     </div>
                 </div>
             ...
             <div class="modal-content">
                 ...
                 <div class="modal-body text-justify">
                     <form class="form-horizontal"
                         action="<?php echo base_url() . 'pegawai/edit-profil' ?>/<?= $user['id'] ?>" method="post"
                                 ...
                                 <div class="row">
                                     ...
                                     <div class="col-sm-2 ml-3">
                                         <img src="<?php echo base_url() . '/gambar/pegawai/' . $user['image']; ?>"
                                             class="card-img mx-auto d-block" style="width: 120px; height: 140px;">
                                     </div>
     ...
     <div class="modal fade myModalpassword" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel"
         aria-hidden="true">
         <div class="modal-dialog ">
             <div class="modal-content">
                 <div class="modal-header text-center">
                 ...
                 <div class="modal-body text-justify">
                     ...
                     <form class="form-horizontal"
                         action="<?php echo base_url() . 'pegawai/edit-password' ?>/<?= $user['id'] ?>" method="post"
                         enctype="multipart/form-data">
                         <div class="modal-body">
                             <div class="form-group">
